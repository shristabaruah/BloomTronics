    ...
    <div className="card-horizontal">
      ...
      <div className="card-main">
        ...
        <div className="qty">
          ...
          <button className="minus" onClick={()=>updateQtyHandler(product ,"decrement",_id)}>-</button>
          <input  type="number" value={qty} readOnly  />
          <button className="add" onClick={()=>updateQtyHandler(product,"increment",_id)}>+</button>
        </div>
        <div className="horizontal-btn">
          <button className="btn secondary-solid buy-now" onClick={()=>removeCartHandler(product)}>REMOVE</button>
          <button className="btn secondary-solid wishlist" onClick={()=>moveToWishlistHandler(product)}>
            MOVE TO WISHLIST
          </button>
        </div>
      </div>
